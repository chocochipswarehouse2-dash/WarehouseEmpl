...
-- CLONE DATA - MODE ISOLASI AMAN (HANYA MEMPENGARUHI 9 TABEL WMS)
-- JAMINAN: Tabel-tabel lain di Supabase tujuan 100% AMAN & TIDAK TERSENTUH!
-- ==============================================================================
...
-- ==============================================================================
-- 1. BERSIHKAN HANYA 9 TABEL WMS TERKAIT (Tabel lain di database TIDAK tersentuh)
-- ==============================================================================
DELETE FROM presensi;
DELETE FROM roster_shift;
DELETE FROM lembur;
DELETE FROM perijinan_cuti;
DELETE FROM pengajuan_profil;
DELETE FROM kasbon;
DELETE FROM payroll;
DELETE FROM master_shift;
DELETE FROM karyawan;

-- ==============================================================================
-- 2. INSERT SELURUH DATA WMS DARI DATABASE SUMBER
-- ==============================================================================
...
-- Sinkronisasi urutan auto-increment ID khusus tabel WMS
